# EraaSoft Task Manager App
The EraaSoft Task Manager App is a powerful and intuitive task management tool designed to help users create, organize, and track tasks efficiently.
...
The EraaSoft Task Manager App is a comprehensive task management solution designed to help users stay organized and productive. Whether you're managing personal to-dos or professional projects, this app provides a seamless experience for creating, updating, and tracking tasks. Built with user convenience in mind, the app ensures that your data is always secure and accessible, even when offline. Once an internet connection is restored, the app automatically syncs your tasks with EraaSoft's secure servers, ensuring your data is always up-to-date.
...
1. **Splash Screen for Android < 12.0**  
   The splash screen displayed on devices running Android versions below 12.0.  
<p align="center">
<img src="https://github.com/user-attachments/assets/9193067e-69b6-4cba-aac3-2f9bd9be17bc"  width="300" height="600">
  
2. **Splash Screen for Android 12.0+**  
   The updated splash screen designed for devices running Android 12.0 and above.  
<p align="center">
<img src="https://github.com/user-attachments/assets/8a96b90d-3530-49d9-b677-a5f12202e0f8" alt="Android 12 Splash Screen" width="300" height="auto" />
...
<p align="center">
<img src="https://github.com/user-attachments/assets/3f07b906-04c6-4c20-8140-1f4d08143aff"  width="300" height="600">
  
4. **Text Field Validation**  
   Real-time validation of input fields to ensure data accuracy during signup.
<p align="center">
<img src="https://github.com/user-attachments/assets/e981e982-0624-4216-8e9c-1181b4da9d80"  width="300" height="600">
<img src="https://github.com/user-attachments/assets/6e505ae6-36ee-4668-a704-60146ce6cde8"  width="300" height="600">
  
5. **Error and Exception Handling**  
   Examples of error messages displayed during signup for invalid inputs or server issues. 
<p align="center">
<img src="https://github.com/user-attachments/assets/fadb8275-a915-471d-93f7-599a47a445f8"  width="300" height="600">

6. **Successful Signup and Navigation to Login**  
   After a successful signup, users are automatically navigated to the login page with their email pre-filled.  
<p align="center">
<img src="https://github.com/user-attachments/assets/6edee1f1-d014-4c55-8cc2-1363e8a26bb6"  width="300" height="600">  
